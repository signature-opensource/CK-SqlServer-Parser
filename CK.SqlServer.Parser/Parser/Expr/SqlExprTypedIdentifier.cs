...
namespace CK.SqlServer.Parser
{
    ...
    public class SqlExprTypedIdentifier : SqlItem
    {
        ...
        private static ISqlNode[] Build( SqlTokenIdentifier identifier, SqlToken optAsToken, SqlExprTypeDecl type )
        {
        ...
        internal SqlExprTypedIdentifier( ImmutableList<SqlTrivia> leading, ISqlNode[] items, ImmutableList<SqlTrivia> trailing )
