...
namespace CK.SqlServer.Parser
{
    ...
    {
        public SelectColumnList( IList<ISqlNode> components )
            : base( null, EnsureArray( components ), null )
        {
        }

        internal SelectColumnList( ImmutableList<SqlTrivia> leading, ISqlNode[] items, ImmutableList<SqlTrivia> trailing )
