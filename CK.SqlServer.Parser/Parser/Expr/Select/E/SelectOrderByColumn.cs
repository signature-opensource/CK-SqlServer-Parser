...
{
    public sealed class SelectOrderByColumn : SqlNode
    {
        readonly SNode<ISqlNode, SqlTokenIdentifier> _content;

        public SelectOrderByColumn( ISqlNode definition, SqlTokenIdentifier ascOrDesc = null )
            : base( null, null )
        {
        ...
        SelectOrderByColumn( SelectOrderByColumn o, ImmutableList<SqlTrivia> leading, IEnumerable<ISqlNode> items, ImmutableList<SqlTrivia> trailing )
        ...
        {
            return new SelectOrderByColumn( this, leading, children, trailing );
        }
