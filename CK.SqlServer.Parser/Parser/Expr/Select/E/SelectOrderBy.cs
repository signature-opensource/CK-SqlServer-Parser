...
namespace CK.SqlServer.Parser
{
    ...
    {
        readonly SNode<ISelectSpecification, SqlTokenIdentifier, SqlTokenIdentifier, SelectOrderByColumnList, SelectOrderByOffset> _content;

        public SelectOrderBy( ISelectSpecification select, SqlTokenIdentifier orderT, SqlTokenIdentifier byT, SelectOrderByColumnList columns, SelectOrderByOffset offset = null )
            : base( null, null )
        {
            _content = new SNode<ISelectSpecification, SqlTokenIdentifier, SqlTokenIdentifier, SelectOrderByColumnList, SelectOrderByOffset>(
                select, 
                orderT, 
                byT, 
                columns, 
            ...
            : base( leading, trailing )
        {
            ...
            {
                _content = new SNode<ISelectSpecification, SqlTokenIdentifier, SqlTokenIdentifier, SelectOrderByColumnList, SelectOrderByOffset>( items );
                CheckContent();
            }
        }
        ...
        public SelectOrderByColumnList OrderByColumns => _content.V4;
