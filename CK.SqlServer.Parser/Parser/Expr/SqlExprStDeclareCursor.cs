...
namespace CK.SqlServer.Parser
{
    ...
    public class SqlExprStDeclareCursor : SqlExprBaseSt
    {
        ...
        SqlExprStDeclareCursor( ImmutableList<SqlTrivia> leading, ISqlNode[] items, ImmutableList<SqlTrivia> trailing )
        ...
        static ISqlNode[] Build( SqlTokenIdentifier declareToken, SqlTokenIdentifier variable, ISqlExprCursor cursor )
        {
