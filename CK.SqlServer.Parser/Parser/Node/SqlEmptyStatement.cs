...
namespace CK.SqlServer.Parser
{
    ...
    public sealed class SqlEmptyStatement : SqlNonToken, ISqlNamedStatement
    {
        ...
        {
            _content = new[] { statementTerminator };
        ...
        public override IList<ISqlNode> GetRawContent() => (SqlTokenTerminal[])_content.Clone();

        /// <summary>
        /// Gets the optional terminator. 
        /// </summary>
        public SqlTokenTerminal StatementTerminator => _content[0];

        protected override SqlNode DoClone( ImmutableList<SqlTrivia> leading, IList<ISqlNode> content, ImmutableList<SqlTrivia> trailing )
        {
            return new SqlEmptyStatement( content == null ? _content[0] : (SqlTokenTerminal)content[0], leading, trailing );
        }
