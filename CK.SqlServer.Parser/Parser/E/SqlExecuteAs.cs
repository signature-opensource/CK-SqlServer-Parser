...
namespace CK.SqlServer.Parser
{
    public sealed class SqlExecuteAs : SqlNode
    {
        ...
        public SqlExecuteAs( SqlTokenIdentifier execToken, SqlTokenIdentifier asToken, SqlToken right )
            : base( null, null )
        {
            _content = new SNode<SqlTokenIdentifier, SqlTokenIdentifier, SqlToken>( execToken, asToken, right );
            CheckContent();
        }
        ...
        protected SqlTokenIdentifier AsT => _content.V2;
