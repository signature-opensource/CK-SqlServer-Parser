...
namespace CK.SqlServer.Parser.Tests
{
    ...
    public class SqlNodeTests
    {
        class TestNode : SqlNode
        {
            ...
            {
                b.Append( Name );
                foreach( var c in _nodes ) c.Write( b );
            }
        }
        ...
        public void SqlNode_trivias_can_be_lifted()
        {
            ...
            Assert.That( n.ToString(), Is.EqualTo( "N[b1[[a1[N1]a1]]b1][b2[[a2[N2]a2]]b2]" ) );
            ...
            Assert.That( nRightLift.ToString(), Is.EqualTo( "N[b1[[a1[N1]a1]]b1][b2[[a2[N2" ) );
            ...
            Assert.That( nLift.ToString(), Is.EqualTo( "NN1]a1]]b1][b2[[a2[N2" ) );
        }
